...
namespace LayeredSolution.Szamlazo
{
    public partial class ProductsForm : Form
    {
        ...
        private void searchTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            var bindingList = (BindingList<ProductModel>)productModelBindingSource.DataSource;
            bindingList.Clear();
            foreach (var productModel in _productService.GetAllProduct(searchTextBox.Text))
            {
